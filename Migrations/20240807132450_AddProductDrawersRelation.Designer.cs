...
namespace BW2_Team6.Migrations
{
    ...
    [Migration("20240807132450_AddProductDrawersRelation")]
    partial class AddProductDrawersRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrawerProduct", b =>
                {
                    b.Property<int>("DrawersId")
                        .HasColumnType("int");

                    b.Property<int>("ProductId")
                        .HasColumnType("int");

                    b.HasKey("DrawersId", "ProductId");

                    b.HasIndex("ProductId");

                    b.ToTable("DrawerProduct", (string)null);
                });
            ...
            modelBuilder.Entity("DrawerProduct", b =>
                {
                    b.HasOne("BW2_Team6.Models.Drawer", null)
                        .WithMany()
                        .HasForeignKey("DrawersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BW2_Team6.Models.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
